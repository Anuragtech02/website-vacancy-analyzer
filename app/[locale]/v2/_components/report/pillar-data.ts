...
export const PILLAR_DATA: PillarDatum[] = [
  ...
  },
  {
    ...
    score: 5.2,
    label: "Needs work",
    verdict: "No mention of learning budget, mentorship, internal mobility, or what \"senior\" looks like a year from now.",
    tone: "warn",
  },
  {
    key: "culture",
    score: 8.1,
    label: "Strong",
    verdict: "Team culture comes through. \"Pizza Fridays\" aside, the voice feels like a real person wrote it. Keep this.",
    tone: "ok",
  },
  {
    key: "cta",
